...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { content: @support.content, email: @support.email } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { content: @support.content, email: @support.email } }
